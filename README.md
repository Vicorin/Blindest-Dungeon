...
Download Darkest Dungeon and run the game at least once.

Download and extract the mod files. Found in the releases for this repository.

Locate your game files. Inside the main directory, go to Windows > Win64, where you should see the Darkest.exe. Paste the DDAcess.DLL, the NVDA Controller. DLL, Tolk.DLL, and the Darkest Access launcher into that folder, alongside the game's normal exe.

Run Darkest Access to launch the game. After several seconds, you should hear "Accessibility mod loaded", which indicates the mod installed correctly and is running. You can create a desktop shortcut for the launcher or modify your Steam launch settings so you don't have to go into this folder every time to run the game.
